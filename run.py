        ...
        dbc.Col(
            html.P(
                [
                    ...
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/samuelhepner/bitcoin-prediction'), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/samuel-hepner/'), 
                ], 
                className='lead'
            )
        )
